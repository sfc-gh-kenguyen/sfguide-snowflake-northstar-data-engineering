-- ============================================================
-- Snowflake Northstar Data Engineering — SETUP (solution)
...
-- Required to clone a public GitHub repo as a Workspace.
-- ------------------------------------------------------------
CREATE OR REPLACE API INTEGRATION github_snowflake_labs
